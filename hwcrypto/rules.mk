...
ifeq (true,$(call TOBOOL,$(APPLOADER_ENCRYPT_KEY_0_UNLOCKED_ONLY)))
MODULE_COMPILEFLAGS += \
	-DAPPLOADER_ENCRYPT_KEY_0_UNLOCKED_ONLY=1
endif
endif
...
ifeq (true,$(call TOBOOL,$(APPLOADER_ENCRYPT_KEY_1_UNLOCKED_ONLY)))
MODULE_COMPILEFLAGS += \
	-DAPPLOADER_ENCRYPT_KEY_1_UNLOCKED_ONLY=1
endif
endif
